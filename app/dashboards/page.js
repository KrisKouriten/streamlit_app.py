 ...
 */
const DASHBOARDS = [
  { n: 1, title: "Management Accounts", href: "/finance-os/management-accounts", kind: "xero",
    blurb: "Consolidated profit & loss — real Xero actuals across the connected entities." },
