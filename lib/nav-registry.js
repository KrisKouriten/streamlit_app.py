...
export const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Marketing Dashboard", href: "/dashboards/department-budget?dept=Marketing", hint: "Marketing budget, P.Os, committed spend & challenges" },
      { label: "Finance Dashboard", href: "/dashboards/department-budget?dept=Finance", hint: "Finance department budget & purchase orders" },
      { label: "Merchandising Dashboard", href: "/dashboards/department-budget?dept=Merchandising", hint: "Merchandising budget & purchase orders" },
      { label: "Operations Dashboard", href: "/dashboards/department-budget?dept=Operations", hint: "Operations budget & purchase orders" },
      { label: "HR Dashboard", href: "/dashboards/department-budget?dept=HR", hint: "HR budget & purchase orders" },
      { label: "Logistics Dashboard", href: "/dashboards/department-budget?dept=Logistics", hint: "Logistics budget & purchase orders" },
      { label: "Architecture & Build Dashboard", href: "/dashboards/department-budget?dept=Architecture%20%26%20Build", hint: "Architecture & Build budget & purchase orders" },
