...
export const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "SKU Analysis Dashboard", href: "/finance-os/sku-analysis", hint: "Top 80 / Bottom 20 · dormant stock · new SKU performance" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Close Cockpit", href: "/operate/close", hint: "Month-end close readiness — auto-checked gates & the lock control" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "P&L Formats", href: "/govern/pl-formats", hint: "Board-pack P&L layouts and nominal mapping" },
