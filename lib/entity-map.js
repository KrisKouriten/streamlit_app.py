/*
 * Joiin company id ↔ legal entity name (the 26 group companies). Pure data, no
 * DB import, so both the app and the standalone refresh scripts can use it.
 */
...
export const JOIIN_CLIENT_ID = "50cb9650-5c51-11ee-8e13-dbfb7e69a8bf";
