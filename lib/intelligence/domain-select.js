...
const SIGNALS = [
  ["otb_merchandising", /\b(open.?to.?buy|\botb\b|merchandising (buy|purchas|plan)|buying plan|purchase capacity|remaining (buy|otb)|miniso mds|local purchase|stock investment|open to buy)\b/i],
