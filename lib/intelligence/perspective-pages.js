...
export const PERSPECTIVE_PAGES = [
  ...
  // Pricing / Capex (PLAN)
  { id: "pricing",             name: "Pricing Review",             route: "/plan/pricing" },
  { id: "pricing-scenario",    name: "Pricing Scenario",           route: "/plan/pricing-scenario" },
  { id: "capex",               name: "Capex Investment",           route: "/plan/capex" },
];
