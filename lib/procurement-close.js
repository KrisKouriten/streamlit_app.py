...
import { financeActionError, isProcChallengeReason, challengeNoteError, isProcPaymentStatus, isProcPaymentMethod, committedAmount, lineValue, lcActionError, LC_BANK_DEFAULT, reportBasis, reportedGbp, REPORT_RATE_TYPES, dcDrawdown, validateDc } from "./procurement-close-rules.js";
...
export async function setPaymentStatus(id, { payment_status, paid_date, payment_method }, actor) {
  ...
  await audit({ actor, eventType: "procurement.payment", objectType: "procurement_purchase", objectRef: String(id), detail: { payment_status, payment_method: method } });
  return { ok: true };
}
