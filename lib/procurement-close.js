...
import { financeActionError, isProcChallengeReason, isProcPaymentStatus, committedAmount, lineValue, lcActionError, LC_BANK_DEFAULT, reportBasis, reportedGbp, REPORT_RATE_TYPES } from "./procurement-close-rules.js";
...
export async function procurementRollup() {
  try {
    ...
    const [rows, { rows: budgets }, fxRates] = await Promise.all([
      selectPurchases(),
