...
export const CRITICAL_COLUMNS = [
  ...
  { table: "procurement_purchase", column: "vat_rate", migration: "116_procurement_vat.sql", feature: "Gross vs net on a request — without it every month commits net and under-reports the cash" },
