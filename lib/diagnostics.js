...
export async function getDiagnostics() {
  ...
  const checks = [
    ...
    // The same SPOT resolver Trade-pay spend converts with, so the restatement
    // this reports is the one the desk actually applied.
    facilityCheck(facility, ratedSpot, (ccy) => findRate(rates || [], ccy, "SPOT")),
