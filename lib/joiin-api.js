 ...
 * committed. Endpoints used: report/profit-and-loss, report/custom-report,
 * company/list. Response mapping lives in joiin-api-map.js (pure + tested);
...
// Profit & Loss for a set of companies over a month range (YYYY-MM).
export async function profitAndLoss({ companies, startDate, endDate, currency = "GBP" }) {
  return post("/report/profit-and-loss", { companies, startDate, endDate, currency });
}
