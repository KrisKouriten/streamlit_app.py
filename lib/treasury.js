...
import {
  ...
  isSalesStream, lcStage, lcStageLabel, facilityLifecycleSummary,
...
export async function getTreasuryOverview() {
  const [facility, loans, hedging, sales, recon, lifecycle, position] = await Promise.all([
  ...
  return { facility, loans, hedging, sales, recon, lifecycle, position };
}
