...
export const INVESTMENT_COMPONENTS = [
  ...
  "rent", "business_rates", "service_charge", "contingency", "other",
];
// Occupancy costs are part of the upfront investment but are operating costs,
// so they are excluded from the depreciable capex base.
export const NON_DEPRECIABLE_COMPONENTS = ["inventory", "working_capital", "rent", "business_rates", "service_charge"];
