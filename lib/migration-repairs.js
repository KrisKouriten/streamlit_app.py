...
export const REPAIRS = [
  ...
  {
    key: "procurement_purchase.vat_rate",
    table: "procurement_purchase",
    column: "vat_rate",
    migration: "116_procurement_vat.sql",
    sql: "ALTER TABLE finance.procurement_purchase ADD COLUMN IF NOT EXISTS vat_rate numeric(5,4)",
    feature: "The VAT basis on a request — amount_gbp is net, and the gross is what leaves the bank",
  },
  {
