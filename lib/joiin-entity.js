...
import { STORE_FORMAT, FRANCHISE_FORMAT, renderFormat, buildGenericFormat, classifyEntity } from "./pl-format.js";
...
export async function getEntityPnl(selected) {
  ...
  let fmt;
  if (kind === "store") fmt = STORE_FORMAT;
  else if (kind === "franchise") fmt = FRANCHISE_FORMAT;
  else {
